...
class AppColors {
  ...
  static const Color darkBackgroundHover = Color(0xFF111111);
  static const Color darkBackgroundPress = Color(0xFF222222);
  static const Color darkBorderColor = Color(0xFF333333);
  static const Color darkBorderColorHover = Color(0xFF444444);
  static const Color darkBorderColorPress = Color(0xFF555555);
  static const Color darkBorderColorFocus = Color(0xFF666666);
  ...
  static const Color redColor = Color(0xFFFF7675);
